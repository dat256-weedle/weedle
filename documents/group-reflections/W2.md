...
**A**: Currently we only have a simple template for the application, altough it is possible to start the application and see some things on the screen of your phone. This provides value for both us as developers as well as our product owner. The chosen scope is currently quite small as we are still learning a lot and getting into the project. 
